...
import {
    Container, Wrapper, H1, Content, Line, Div, BackgroundText, CircleHold,Circle1,Circle2, Circle3, Topic, CountHold,CountInput, ProfitHold, CalculatorDiv, Left, Number, Mid, Right, BottomDiv, BottomLeft, Top, Info, Texts, Bottom, Icon, BottomRight, Circle4, Label, FirstWrap
