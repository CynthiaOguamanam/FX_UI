...
import sitelock from '../../../Assets/sitelock.png'
import trustwave from '../../../Assets/trustwave.png'
import macAfee from '../../../Assets/mcafee.png'
import geotrust from '../../../Assets/geotrust.png'
import norton from '../../../Assets/Norton.png'
import trustguard from '../../../Assets/trustguard.png'
...
const Hero6 = () => {
  return (
    <Container>
        ...
        <Wrapper>
        <Marquee style={{width: "100%"}} pauseOnHover={true} speed={50} gradientWidth={"40px"}>
